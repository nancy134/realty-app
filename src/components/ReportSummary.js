...
export function Logo(props){
     var url = "https://sabre-images.s3.amazonaws.com/FindingCRELogo.png?noCache=" + Math.random().toString();
     return(
        <Image
            style={{
                width: 265,
...
function propertyUses(arrayPropertyUses){
    var items = "";
    for (var i=0; i<arrayPropertyUses.length; i++){
        if (i !== 0){
            items += ", " + arrayPropertyUses[i];
        } else {
            items += arrayPropertyUses[i];
        }
    }
...
function PropertyUses(props){
    var strPropertyUses = propertyUses(props.propertyUses);
    if (props.propertyUses.length > 0){
        return(
            <View
                style={styles.tableCol}
            >
    ...
    return(
        ...
        >
            ...
            >
                ...
                <View style={styles.table}>
                    <View style={styles.tableRow}>
                        <View key={97} style={styles.tableCol}>
                    ...
                    <View style={styles.tableRow}>
                        <View key={97} style={styles.tableCol}>
                            <Text style={styles.tableCellHeader}>Listing Type</Text>
                        </View>
                        {listItems.map((listItem, index) => (
                            <View key={index} style={styles.tableCol}>
                    ...
                    <View style={styles.tableRow}>
                        <View key={97} style={styles.tableCol}>
                            <Text style={styles.tableCellHeader}>Available Space</Text>
                        </View>
                        {listItems.map((listItem, index) => (
                            <ListItemSize
                                key={index}
                         ...
                         { count < 5 ?
                            <View key={98} style={styles.tableCol}>
                            </View>
                         : null }
                    ...
                    <View style={styles.tableRow}>
                        ...
                        {listItems.map((listItem, index) => (
                            <ListItemPrice
                                key={index}
                                spaces={listItem.listing.versions[0].spaces}
                                listingType={listItem.listing.versions[0].listingType}
                                listingPrice={listItem.listing.versions[0].listingPrice}
                            />
                         ))}
                         { count < 4 ?
                            <View key={99} style={styles.tableCol}>
                    ...
                    <View style={styles.tableRow}>
                        ...
                        {listItems.map((listItem, index) => (
                            <PropertyUses
                                key={index}
                                propertyUses={listItem.listing.versions[0].propertyTypes}
                            />
                         ))}
                         { count < 4 ?
                            <View key={99} style={styles.tableCol}>
                    ...
                    <View style={styles.tableRow}>
                        ...
                        {listItems.map((listItem, index) => (
                            <View key={index} style={styles.tableCol}>
                                <Text style={styles.tableCell}>{listItem.listing.versions[0].shortDescription}</Text>
                            </View>
                         ))}
                         { count < 4 ?
                            <View key={99} style={styles.tableCol}>
