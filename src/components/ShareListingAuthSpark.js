...
class ShareListingAuthSpark extends React.Component{
    constructor(props){
        super(props);
    ...
    render(){
        ...
        >
            ...
            <Modal.Body>
                ...
                <Row>
                    { this.state.loggedIn ?
                    <p><span>You are logged into Spark: {this.state.authorizationCode}</span></p>
...
export default ShareListingAuthSpark;
